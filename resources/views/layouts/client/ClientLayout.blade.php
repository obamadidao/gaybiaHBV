...
<script>
               ...
               function updateProfileOrdersView(data) {
                   ...
                   if (!orderTable) return;
                    ...
                    // Cập nhật payment status nếu có thông tin trong data
                    if (data.payment_status !== undefined && typeof window.updateProfilePaymentStatus === 'function') {
                        window.updateProfilePaymentStatus(data.order_id, data.payment_status);
                    }
