...
<div class="item text-center d-flex d-flex-justify-center flex-column flex-sm-row text-uppercase">
                    ...
                    <span class="icon-text d-flex-justify-center mb-2 mb-sm-0 "><i class="fs-3 icon anm anm-truck-l me-2 me-sm-3"></i> <strong class="me-1">Giao hàng nhanh 100% miễn phí</strong> Không cần liên hệ với người giao hàng</span>
                    <a href="shop-top-filter.html" class="btn btn-light ms-sm-3">Đặt hàng ngay</a>                        
</div>                       
</div>
</div>
</div>
...
<form action="#" method="post">
                            <label class="h4 mb-2">Sign Up for Our Newsletter</label>
                            <p>Subscribe to the mailing list to receive updates on new arrivals, special offers</p>
                            <label class="h4 mb-2">Đăng ký nhận bản tin</label>
                            <p>Đăng ký để nhận thông tin về sản phẩm mới, ưu đãi đặc biệt</p>
<div class="input-group">
                                ...
                                <input type="email" class="form-control input-group-field newsletter-input" name="email" value="" placeholder="Nhập địa chỉ email của bạn..." required />
<button type="submit" class="input-group-btn text-link newsletter-submit" name="commit"><i class="icon anm anm-arw-right"></i></button>
</div>
</form>
...
<div class="col-12 col-sm-12 col-md-4 col-lg-3 footer-links ps-lg-5">
                    ...
                    <h4 class="h4">Tài khoản của tôi</h4>
<ul>
                        ...
                        <li><a href="faqs-style1.html">Lịch sử đơn hàng</a></li>
                        <li><a href="contact-style1.html">Liên hệ với chúng tôi</a></li>
...
<ul>
                        ...
                        <li><a href="aboutus-style1.html">Về chúng tôi</a></li>
                        <li><a href="contact-style1.html">Liên hệ</a></li>
                        <li><a href="blog-grid.html">Tin tức mới nhất</a></li>                                   
...
<div class="col-12 col-sm-12 col-md-4 col-lg-3 footer-contact">
                    ...
                    <p class="phone d-flex align-items-center"><i class="icon anm anm-phone-l"></i>  <b class="me-2 fw-400">Toll Free</b> <a href="tel:401234567890">(+40) 123 456 7890</a></p>
                    <h4 class="h4">Thông tin liên hệ</h4>
                    <p class="address d-flex"><i class="icon anm anm-map-marker-al pt-1"></i> 123 Tên đường, Thành phố, Việt Nam</p>
                    <p class="phone d-flex align-items-center"><i class="icon anm anm-phone-l"></i>  <b class="me-2 fw-400">Hotline</b> <a href="tel:401234567890">(+84) 123 456 789</a></p>
<p class="email d-flex align-items-center"><i class="icon anm anm-envelope-l"></i> <b class="me-1 d-none">Email:</b> <a href="mailto:info@example.com">info@example.com</a></p>
                    ...
                    <p class="work-hour d-flex mb-0"><i class="icon anm anm-clock-r pt-1"></i><span class="hour-time">Giờ làm việc: <br/>Thứ 2 - Chủ nhật / 9:00 - 20:00</span></p>
</div>
</div> 
</div>                       
</div>               
...
<li><i class="icon anm anm-cc-jcb"></i></li>
                ...
                <div class="copytext">&copy; 2025 HBV Billiards. Đã đăng ký bản quyền.</div>
</div>
</div>
</div>