...
<li class="lvl1"><a href="{{ route('client.category', 'den-ban-bida') }}">Đèn bàn</a></li>
                        ...
                        <li class="lvl1"><a href="{{ route('client.contact.index') }}">Liên hệ</a></li>
</ul>
</nav>
</div>
<!--End Menu-->
...
<form class="form minisearch search-inline-brd" id="header-search0" action="{{ route('client.search') }}" method="get">
<label class="label d-none"><span>Search</span></label>
<!--Search Field-->
<div class="d-flex searchField">
<div class="input-box d-flex fl-1">
<input type="text" name="query" class="form-control input-group-field search-input border-0" placeholder="Tìm kiếm sản phẩm..." value="{{ request('query') }}" required />
