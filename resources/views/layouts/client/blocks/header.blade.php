...
<ul id="siteNav" class="site-nav medium left">
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Cơ Bida<i class="icon anm anm-angle-down-l"></i></a>
<ul class="dropdown">
                                ...
                                <li><a href="#" class="site-nav">Grid View</a></li>
                                ...
                                <ul class="row grid--uniform mmWrapper">
                                    ...
                                    <li class="lvl-1 col-md-3 col-lg-3 w-34 banner-col">
                                        <div class="banner-wrap">
                                            <a href="shop-left-sidebar.html"><img class="blur-up lazyload" data-src="assets/images/megamenu/demo5-banner-menu.jpg" src="assets/images/megamenu/demo5-banner-menu.jpg" alt="banner" width="500" height="600" /></a>
                                            <div class="banner-content">
                                                <h4>Hot deals</h4>
                                                <h3>Don't miss <br>Trending</h3>
                                                <div class="banner-btn"><a href="shop-left-sidebar.html" class="btn btn-primary btn-small">Shop now</a></div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                        ...
                                        <div class="grid-products weekly-product gp10 mt-1">
                                            <div class="item">
                                                <div class="product-wrap position-relative">
                                                    ...
                                                    <div class="product-image mb-0">
                                                        <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="assets/images/products/tools1.jpg" src="assets/images/products/tools1.jpg" alt="product" title="Product" width="625" height="781" /></a>
                                                        <div class="product-labels"><span class="lbl on-sale">Sale</span></div>
                                                    </div>
                                                    <!-- End Product Image -->
                                                    <!-- Start Product Details -->
                                                    <div class="product-details text-center">
                                                        <div class="product-name"><a href="product-layout1.html">Tool Plasterer</a></div>
                                            ...
                                            <div class="item">
                                                <div class="product-wrap position-relative">
                                                    <!-- Start Product Image -->
                                                    <div class="product-image mb-0">
                                                        <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="assets/images/products/tools2.jpg" src="assets/images/products/tools2.jpg" alt="product" title="Product" width="625" height="781" /></a>
                                                    </div>
                                                    <!-- End Product Image -->
                                                    <!-- Start Product Details -->
                                                    <div class="product-details text-center">
                                                        <div class="product-name"><a href="product-layout1.html">Hammer Tool</a></div>
                                                        <div class="product-price">
                                            ...
                                            <div class="item">
                                                <div class="product-wrap position-relative">
                                                    <!-- Start Product Image -->
                                                    <div class="product-image mb-0">
                                                        <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="assets/images/products/tools3.jpg" src="assets/images/products/tools3.jpg" alt="product" title="Product" width="625" height="781" /></a>
                                                    </div>
                                                    <!-- End Product Image -->
                                                    <!-- Start Product Details -->
                                                    <div class="product-details text-center">
                                                        <div class="product-name"><a href="product-layout1.html">Planes Hand tool</a></div>
                                                        <div class="product-price">
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Bàn Bida<i class="icon anm anm-angle-down-l"></i></a>
                            <ul class="dropdown">
                                <li><a href="#" class="site-nav">Grid View</a></li>
                                <li><a href="#" class="site-nav">List View</a></li>
                            </ul>
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Phụ kiện <i class="icon anm anm-angle-down-l"></i></a>
<ul class="dropdown">
                                <li><a href="aboutus-style1.html" class="site-nav">About Us <i class="icon anm anm-angle-right-l"></i></a>
                                <li><a href="#" class="site-nav">Bi Bida <i class="icon anm anm-angle-right-l"></i></a>
<ul class="dropdown">
                                        ...
                                        <li><a href="#" class="site-nav">About Us Style1</a></li>
                                        <li><a href="#" class="site-nav">About Us Style2</a></li>
</ul>
</li>
                                <li><a href="contact-style1.html" class="site-nav">Contact Us <i class="icon anm anm-angle-right-l"></i></a>
                                <li><a href="contact-style1.html" class="site-nav">Phụ kiện <i class="icon anm anm-angle-right-l"></i></a>
<ul class="dropdown">
                                        ...
                                        <li><a href="#" class="site-nav">Contact Us Style1</a></li>
                                        <li><a href="#" class="site-nav">Contact Us Style2</a></li>
</ul>
</li>
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Blog <i class="icon anm anm-angle-down-l"></i></a>
                            <ul class="dropdown">
                                ...
                                <li><a href="#" class="site-nav">Đèn bàn</a></li>
</ul>
</li>
                        <li class="lvl1"><a href="#">Liên hệ</a></li>
</ul>
</nav>
</div>
<!--End Menu-->
...
<ul class="m-0">
                                ...
                                <li><a href="#"><i class="icon anm anm-sign-in-al"></i>Đăng nhập</a></li>
                                <li><a href="#"><i class="icon anm anm-user-al"></i>Đăng ký</a></li>
                                <li><a href="#"><i class="icon anm anm-user-cil"></i>Tài khoản</a></li>
                                <li><a href="#"><i class="icon anm anm-sign-out-al"></i>Đăng xuất</a></li>
</ul>
</div>
</div>
</div>
