...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.products.reviews', $product) }}">
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.products.reviews', $product) }}" class="btn btn-outline-secondary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <p class="mb-2">{{ Str::limit($review->content, 100) }}</p>
                                        
                                        @if($review->hasPros())
                                            <div class="mb-1">
                                                <small class="text-success">
                                                    <i class="fas fa-plus-circle me-1"></i>
                                                    {{ Str::limit(implode(', ', $review->safe_pros), 50) }}
                                                </small>
                                            </div>
                                        @endif
                                        ...
                                        @if($review->hasCons())
                                            <div class="mb-1">
                                                <small class="text-danger">
                                                    ...
                                                    {{ Str::limit(implode(', ', $review->safe_cons), 50) }}
                                                </small>
                                            </div>
                                        @endif
